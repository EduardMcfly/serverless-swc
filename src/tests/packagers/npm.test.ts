  ...
  it('should create the same dependency tree from npm v6 and npm v7 output', async () => {
    const v6depsList: NpmV6Deps = {
      ...
      dependencies: {
        'samchungy-a': {
          _args: [
            ['samchungy-a@2.0.0', '/workdir/.swc/.build'],
            ['samchungy-a@2.0.0', '/workdir/.swc/.build'],
          ],
          ...
          _spec: '2.0.0',
          _where: '/workdir/.swc/.build',
          author: '',
          dependencies: {
            'samchungy-dep-a': {
              _args: [
                ['samchungy-dep-a@1.0.0', '/workdir/.swc/.build'],
                ['samchungy-dep-a@1.0.0', '/workdir/.swc/.build'],
              ],
              ...
              _dependencies: {},
              path: '/workdir/.swc/.build/node_modules/samchungy-dep-a',
              error: '[Circular]',
              extraneous: false,
            },
          },
          ...
          path: '/workdir/.swc/.build/node_modules/samchungy-a',
          error: '[Circular]',
          extraneous: false,
        },
        'samchungy-b': {
          _args: [
            ['samchungy-b@2.0.0', '/workdir/.swc/.build'],
            ['samchungy-b@2.0.0', '/workdir/.swc/.build'],
          ],
          ...
          dependencies: {
            'samchungy-dep-a': {
              _args: [
                ['samchungy-dep-a@2.0.0', '/workdir/.swc/.build'],
                ['samchungy-dep-a@2.0.0', '/workdir/.swc/.build'],
              ],
              ...
              optionalDependencies: {},
              _dependencies: {},
              path: '/workdir/.swc/.build/node_modules/samchungy-b/node_modules/samchungy-dep-a',
              error: '[Circular]',
              extraneous: false,
            },
          },
          ...
          path: '/workdir/.swc/.build/node_modules/samchungy-b',
          error: '[Circular]',
          extraneous: false,
        },
      },
  ...
  it('should create the same dependency tree which handles deduping for both npm v6 and v7', async () => {
    const v6depsList: NpmV6Deps = {
      ...
      dependencies: {
        'samchungy-a': {
          _args: [
            ['samchungy-a@3.0.0', '/workdir/.swc/.build'],
            ['samchungy-a@3.0.0', '/workdir/.swc/.build'],
          ],
          ...
          dependencies: {
            'samchungy-dep-b': {
              _args: [
                ['samchungy-dep-b@3.0.0', '/workdir/.swc/.build'],
                ['samchungy-dep-b@3.0.0', '/workdir/.swc/.build'],
              ],
              ...
              dependencies: {
                'samchungy-dep-c': {
                  _args: [
                    ['samchungy-dep-c@1.0.0', '/workdir/.swc/.build'],
                    ['samchungy-dep-c@1.0.0', '/workdir/.swc/.build'],
                  ],
                  ...
                  dependencies: {
                    'samchungy-dep-e': {
                      _args: [
                        ['samchungy-dep-e@1.0.0', '/workdir/.swc/.build'],
                        ['samchungy-dep-e@1.0.0', '/workdir/.swc/.build'],
                      ],
                      ...
                      optionalDependencies: {},
                      _dependencies: {},
                      path: '/workdir/.swc/.build/node_modules/samchungy-dep-e',
                      error: '[Circular]',
                      extraneous: false,
                    },
                  },
                  ...
                  path: '/workdir/.swc/.build/node_modules/samchungy-dep-c',
                  error: '[Circular]',
                  extraneous: false,
                },
                'samchungy-dep-d': {
                  _args: [
                    ['samchungy-dep-d@1.0.0', '/workdir/.swc/.build'],
                    ['samchungy-dep-d@1.0.0', '/workdir/.swc/.build'],
                  ],
                  ...
                  optionalDependencies: {},
                  _dependencies: { 'samchungy-dep-e': '^1.0.0' },
                  path: '/workdir/.swc/.build/node_modules/samchungy-dep-d',
                  error: '[Circular]',
                  extraneous: false,
                },
              },
              ...
              path: '/workdir/.swc/.build/node_modules/samchungy-dep-b',
              error: '[Circular]',
              extraneous: false,
            },
          },
        ...
        'samchungy-b': {
          _args: [
            ['samchungy-b@5.0.0', '/workdir/.swc/.build'],
            ['samchungy-b@5.0.0', '/workdir/.swc/.build'],
          ],
